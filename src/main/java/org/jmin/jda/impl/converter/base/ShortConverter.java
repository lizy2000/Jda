...
public class ShortConverter extends JdaTypeBaseConverter{
	...
	public Object convert(Object value)throws JdaTypeConvertException{
		if(value ==null){
		 ...
		 return Short.valueOf((String)value);
			...
			throw new JdaTypeConvertException("Doesn't support object conversion from type: "+ value.getClass().getName() + " to type: Short.class");
		}
	}
}
