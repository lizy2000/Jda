 ...
 * @author Chris Liao
 */
public class BigDecimalConverter extends JdaTypeBaseConverter {
	...
	public Object convert(Object value)throws JdaTypeConvertException{
		if(value ==null){
			...
			throw new JdaTypeConvertException("Doesn't support object conversion from type: "+ value.getClass().getName() + " to type: BigDecimal");
		}	
	}
 }